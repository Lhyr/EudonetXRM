//tâche #3 341 création de composant Droits d'accès par permission
import EventBus from '../../../../bus/event-bus.js';
export default {
    name: "Permission",
    data() {
        return {
            showPermComponent: this.$store.getters.getPermShow(this.permType),//Afficher les accès par niveau ou pas users
    ...
    computed: {
        ...
        showPerm: {
            get() {
                ...
                return _showPerm || this.showPermComponent;
            },
            set(_showPerm) {
                //if (!_showPerm) {
        ...
        //Niveau de user choisi
        permLevelAccessId: {
            get() {
                return this.getPermLevel(this.permType).toString();
            },
            set(_permLevelAccess) {
                //en cas de modif, on déclenche l'événement de MAJ
                   ...
                   <div class="CheckPermOpt">
                    ...
                    <div class="CheckPermOpt">
                      <div class="ChkPerm"  style="display:flex">
                        ...
                        <div class="globalDivComponent userComponent" style="margin-left:30px;min-width: 40%;" v-show="showPermUserAccess">
