...
export default {
    name: "eUserListMultipleNotEditable",
    data() {
        return {};
    },
    mounted() { },
    ...
    mixins: [eUserMixin],
    template: `
        <span v-if="dataInput.Multiple && dataInput.ReadOnly" :id="'ID_' + dataInput.DescId" class=" noModif multiRenderer form-control input-line fname bold ">
            <ul>
