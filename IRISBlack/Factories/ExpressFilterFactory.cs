...
{
    public class ExpressFilterFactory
    {

        private int _tab = 0;
        private int _searchDescId = 0;
        private int _searchTabDescId = 0;
        private string _searchValue = string.Empty;

        private XDocument xmlResult = new XDocument();
        private XElement _detailsNode = null;
        private int formularType = -1;
        private ePref _pref;

        private ExpressFilterFactory(ePref pref, int tab, int searchDescId, int searchTabDescId, string searchValue)
        {
            _pref = pref;
            _tab = tab;
            _searchDescId = searchDescId;
            _searchTabDescId = searchTabDescId;
        ...
        //    XAttribute xmlAttrib;
        //    XElement xmlExpressValue;
        ...
        //    if (sbError.Length > 0)
        //    {
        //        eErrorContainer ErrorContainer = eErrorContainer.GetDevError(eLibConst.MSG_TYPE.CRITICAL, string.Concat("ExpressFilter (", _tab, " - ", _searchDescId, ") : Erreur lors de la récupération des utilisateurs : ", sbError));
        //        LaunchError();
        //    }
        ...
        //    eErrorContainer ErrorContainer = eErrorContainer.GetDevError(eLibConst.MSG_TYPE.CRITICAL,
        ...
        //    throw new Exception(string.Concat(strBaseError, " : ", sbErr.ToString()));
        //}
        ...
        //    if (_searchTabDescId == TableType.PJ.GetHashCode())
        //        throw new Exception("Pas de filtre express sur une liste d'annexes");
        ...
        //                //    2001 -   inférieur à
        //                //    2003 -   supérieur à
        //                // Je passe de int à long pour avoir une longeur plus grande en saisie
        ...
        //    if (fldSrch.Descid == (int)HistoField.DESCID || fldSrch.Descid == (int)HistoField.EXPORT_TAB || fldSrch.Descid == (int)CampaignField.MAILADDRESSDESCID)
        //    {
        ...
        //            _detailsNode.Add(items
        //                .Select(item => new XElement("element",
        ...
        //            eCatalog _cat = new eCatalog(dal, _pref, fldSrch.Popup, _pref.User, _searchDescId, fldSrch.bTreeView,
        //                new List<eCatalog.CatalogValue>(), "", _pref.IsSnapshot, true, false, -1);

        //            _detailsNode.Add(_cat.Values
        //                .Select(val => new XElement("element", 
        //                    new XAttribute("value", eLibTools.CleanXMLChar(val.DbValue)),
        //                    eLibTools.CleanXMLChar(val.Label))));


        //            //foreach (eCatalog.CatalogValue val in _cat.Values)
        //            //{
        //            //    XmlNode _expressValue = xmlResult.CreateElement("element");
        ...
        private void QuickUserFilter(eudoDAL dal)
        {
            ...
            _detailsNode.Add(uli
                .Where(currentULI => !currentULI.Hidden)
                .Select(currentULI => new XElement("element",
                        new XAttribute("value", currentULI.ItemCode),
                        new XAttribute("usrgrp", (currentULI.Type == eUser.UserListItem.ItemType.GROUP) ? "grp" : "usr"),
                        new XAttribute("disabled", (currentULI.Disabled) ? "1" : "0"),
                        currentULI.Libelle)));
