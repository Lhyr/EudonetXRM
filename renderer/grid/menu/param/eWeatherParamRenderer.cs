...
namespace Com.Eudonet.Xrm
{
    ...
    /// </summary>
    public class eWeatherParamRenderer : eWidgetSpecificParamRenderer
    {

        /// <summary>
        /// TODO Besoin d'un objet metier de la table
        /// </summary>    
        public eWeatherParamRenderer(ePref pref, bool isVisible, eFile file, eXrmWidgetParam param) : base(pref, isVisible, file, param)
        {
        }
        ...
        protected override void BuildWidgetContentPart()
        {
            ...
            _pgContainer.Controls.Add(BuildInputField(eResApp.GetRes(Pref, 8147), _contentParamField));
        }
    }
}