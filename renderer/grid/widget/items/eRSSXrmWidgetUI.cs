...
{
    /// <summary>
    /// Classe de rendu du widget RSS
    /// </summary>
    /// <seealso cref="Com.Eudonet.Xrm.eAbstractXrmWidgetUI" />
    public class eRSSXrmWidgetUI : eAbstractXrmWidgetUI
    {
        /// <summary>
        ...
        public override void Build(HtmlControl widgetContainer)
        {
            ...
            iframe.Attributes.Add("src", string.Concat("eXrmWidgetContentUI.aspx?wt=", (int)EudoQuery.XrmWidgetType.RSS, "&wid=", _widgetRecord.MainFileid, "&c=", context));
