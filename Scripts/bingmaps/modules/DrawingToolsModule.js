    ...
    DrawingManager: function (map, options) {
        ...
        *******************************/
        ...
        this.setDrawingMode = function (mode) {
            ...
            if (drawingMode) {
                ...
                eventIds.push(Microsoft.Maps.Events.addHandler(map, 'dblclick', function (e) {
                    //Stop drawing when spacebar button pressed.
                    //if (e.keyCode == '32') {
                    e.handled = true;
                    endDrawing();
        ...
        *******************/
        ...
        function endDrawing() {
            ...
            if (currentShape && (drawingMode == 'polygon' || drawingMode == 'rectangle' || drawingMode == 'circle' || drawingMode == 'polyline')) {
                ...
                if (_options.events && _options.events.drawingEnded &&
                    (drawingMode == 'polygon' || drawingMode == 'polyline' || drawingMode == 'rectangle' || drawingMode == 'circle')) // CRU : Ajout de "rectangle" et "circle"
                {
            ...
            if (isDrawing) {
                ...
                switch (drawingMode) {
                    ...
                    case "circle":
                        ...
                        currentShape.ShapeInfo.radius = DrawingTools.MapMath.haversineDistance(currentLocation, tempLocation, DrawingTools.DistanceUnit.meters);
                        var locs = DrawingTools.MapMath.generateRegularPolygon(currentLocation, currentShape.ShapeInfo.radius, DrawingTools.DistanceUnit.meters, numCirlceNodes, 0);
                        currentShape.setLocations(locs);
        ...
        function createSvgLine(strokeWidth, dashArray, callback) {
            ...
            bindEvent(svg, 'click', function (e) {
