/***********************************************************************************************************
LMO et NLA les 12 et 13/08/2015
Validé et intégré par MAB le 14/08/2015

Procédure permettant de recopier les modèles de mails unitaires v7 vers la table des modèles de mails XRM
tout en convertissant les champs de fusion en format XRM.

Les modèles de mails originaux sont conservés en l'état et restent utilisables en v7.

Cette procédure est automatisée et n'attend aucun paramètre.
***********************************************************************************************************/
...
Declare Curs2 Cursor For
	-- SOUS-ETAPE 1 - Récupération de tous les templates liés à Contacts et Adresses
	select tab from [PREF] where AdrJoin = 1
	Open Curs2
