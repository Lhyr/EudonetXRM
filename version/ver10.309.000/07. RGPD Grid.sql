...
('Nombre de champs', 'Champs de type RGPD', 14, 6, 0, 6, 3, 1, 1, GETDATE())
...
-- Widget graphique "Consentements"
INSERT INTO [XrmWidget] (Title, SubTitle, [Type], DefaultPosX, DefaultPosY, DefaultWidth, DefaultHeight, ShowHeader, ShowWidgetTitle, XrmWidget95) VALUES
('Consentements', '', 3, 0, 0, 6, 3, 0, 0, GETDATE())
SELECT @widgetId = SCOPE_IDENTITY()
INSERT INTO [XrmGridWidget] (XrmWidgetId, XrmGridId) VALUES (@widgetId, @gridId)
INSERT INTO [XrmWidgetParam] (XrmWidgetId, ParamName, ParamValue) VALUES (@widgetId, 'noAdmin', '1')
INSERT INTO [RES_FILES] ([TAB], [DESCID], [FILEID], [ID_LANG], [LANG]) VALUES (@XrmWidgetDescId, @XrmWidgetTitleDescId, @widgetId, 0, 'Consentements')
INSERT INTO [RES_FILES] ([TAB], [DESCID], [FILEID], [ID_LANG], [LANG]) VALUES (@XrmWidgetDescId, @XrmWidgetTitleDescId, @widgetId, 1, 'Consent')

-- Widget liste "Registre des traitements"
...
('Registre des traitements', '', 4,'', 0, 3, 12, 2, 1, 1, GETDATE())
SELECT @widgetId = SCOPE_IDENTITY()
INSERT INTO [XrmGridWidget] (XrmWidgetId, XrmGridId) VALUES (@widgetId, @gridId)
INSERT INTO [XrmWidgetParam] (XrmWidgetId, ParamName, ParamValue) VALUES (@widgetId, 'showHeader', '0')
INSERT INTO [XrmWidgetParam] (XrmWidgetId, ParamName, ParamValue) VALUES (@widgetId, 'noAdmin', '1')
INSERT INTO [RES_FILES] ([TAB], [DESCID], [FILEID], [ID_LANG], [LANG]) VALUES (@XrmWidgetDescId, @XrmWidgetTitleDescId, @widgetId, 0, 'Registre des traitements')
INSERT INTO [RES_FILES] ([TAB], [DESCID], [FILEID], [ID_LANG], [LANG]) VALUES (@XrmWidgetDescId, @XrmWidgetTitleDescId, @widgetId, 1, 'Processing history')

-- Widget liste "Journal des logs"
INSERT INTO [XrmWidget] (Title, SubTitle, [Type], ContentSource, DefaultPosX, DefaultPosY, DefaultWidth, DefaultHeight, ShowHeader, ShowWidgetTitle, XrmWidget95) VALUES
('Journal des traitements archivés et supprimés', '', 4, '117000', 0, 5, 12, 2, 1, 1, GETDATE())
SELECT @widgetId = SCOPE_IDENTITY()
INSERT INTO [XrmGridWidget] (XrmWidgetId, XrmGridId) VALUES (@widgetId, @gridId)
INSERT INTO [XrmWidgetParam] (XrmWidgetId, ParamName, ParamValue) VALUES (@widgetId, 'showHeader', '0')
