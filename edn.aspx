...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edn.aspx.cs" Inherits="Com.Eudonet.Xrm.edn"
    EnableSessionState="true" EnableViewState="true" UICulture="auto" Culture="auto" %>
...
<head>
    ...
    <script type="text/javascript" lang="javascript">
        ...
        function reloadLang() {
            var ddlLang = document.getElementById("selectLang");
            var idLangSelected = ddlLang.options[ddlLang.selectedIndex].value;

            if (!idLangSelected){
                return false; 
            }
            else {
                //remove hidden re and do postback
                var hiddenField = document.getElementById("re");
                re.parentNode.removeChild(re);

                __doPostBack('<%= selectLang.ClientID %>', idLangSelected);
            }    
        }
    </script>
...
<body>
    <div id="globalPnl" class="ednGlobalPnl">
        ...
        <div id="unsubPnl" class="ednUnsubPnl">
            <p id="unsubTitle" class="ednUnsubTitle"><%=UnsubTitle%></p>
            <%
                if (RendType == ExternalPageRendType.TRACK_UNSUB_CHOICE)
                {
            %>
            <form id="unsubForm" method="post" runat="server">
                ...
                <div class="button-green-edn" onclick="javascript:UnsubMail();">
                    ...
                    <div class="button-green-edn-mid"><%=UnsubButtonLabel%></div>
                    <div class="button-green-edn-right"></div>
                </div>
                <div id="unsubLang" class="ednUnsubLang" runat="server">
                    <asp:DropDownList ID="selectLang" runat="server">
                    </asp:DropDownList>
                </div>
            </form>
            <%--<p class="dotHr"></p>
