...
{
    public partial class eAdminAutocompleteAddressDialog : eAdminPage
    {
        protected int _nTab;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                eAdminRenderer renderer = eAdminRendererFactory.CreateAdminAutocompleteAddressDialogRenderer(_pref, _nTab);
                ...
                formAdminAutocompleteAddress.Controls.Add(renderer.PgContainer);
            }
            catch (Exception exc)
            {
                ErrorContainer = eErrorContainer.GetDevUserError(
                        ...
                        eResApp.GetRes(_pref, 72),
                        String.Concat("Erreur création du renderer dans eAdminAutocompleteAddressDialog : ", exc.Message)
                    );
