...
namespace Com.Eudonet.Xrm.eda
{
    ...
    /// </summary>
    public class eAdminExtensionSynchroExchangeMappingRenderer : eAdminRenderer
    {
        ...
        private eAdminExtensionSynchroExchangeMappingRenderer(ePref pref, int tab) : base()
        {
            _ePref = pref;
            _tab = tab;
        }
        ...
        /// <returns></returns>
        public static eAdminExtensionSynchroExchangeMappingRenderer CreateAdminExtensionSynchroExchangeMappingRenderer(ePref pref, int tab)
        {
            eAdminExtensionSynchroExchangeMappingRenderer rdr = new eAdminExtensionSynchroExchangeMappingRenderer(pref, tab);
            return rdr;
        }
