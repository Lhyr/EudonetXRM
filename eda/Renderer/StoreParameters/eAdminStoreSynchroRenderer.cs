...
namespace Com.Eudonet.Xrm.eda
{
    ...
    /// </summary>
    public class eAdminStoreSynchroRenderer : eAdminStoreFileRenderer
    {
        ...
        /// </summary>
        public eAdminStoreSynchroRenderer(ePref pref, eAdminExtension extension)
            : base(pref, extension)
        {
        ...
        /// <returns></returns>
        public static eAdminStoreSynchroRenderer CreateAdminStoreSynchroRenderer(ePref pref, eAdminExtension ext)
        {
            if (pref.User.UserLevel < UserLevel.LEV_USR_ADMIN.GetHashCode())
                throw new EudoAdminInvalidRightException();

            eAdminStoreSynchroRenderer rdr = new eAdminStoreSynchroRenderer(pref, ext);
            rdr.Generate();
            return rdr;
        }
