...
{
    public partial class eAdminAutomatismsDialog : eAdminPage
    {
        protected int _nTab;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {                
                eRenderer renderer = eAdminRendererFactory.CreateAdminAdvancedAutomationRenderer(_pref, _nTab, _nField);
            ...
            catch (Exception exc)
            {
                ErrorContainer = eErrorContainer.GetDevUserError(
                        ...
                        eResApp.GetRes(_pref, 72),
                        String.Concat("Erreur création du renderer dans eAdminAutomatismsDialog : ", exc.Message)
                    );
