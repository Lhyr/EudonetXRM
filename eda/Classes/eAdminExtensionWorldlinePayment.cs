...
{
    /// <summary>
    /// Extension Worldline Payment
    /// </summary>
    public class eAdminExtensionWorldlinePayment : eAdminExtension
    {
        /// <summary>
        /// Constructeur
        /// </summary>
        ...
        [JsonConstructor]
        public eAdminExtensionWorldlinePayment(eAdminExtensionInfo infos) : base()
        {
            this.Infos = infos;
        }
        ...
        public eAdminExtensionWorldlinePayment(ePref pref) : base(pref, eUserOptionsModules.USROPT_MODULE.ADMIN_EXTENSIONS_WORLDLINE_PAYMENT)
        {
            string strError = "";
