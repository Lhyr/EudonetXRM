...
{
    /// <summary>
    /// Extension parente de toutes les extensions liées aux interfaces de comptabilité (Business Soft, Cegid, Sage, EBP, ...)
    /// Backlogs #330 à #333
    /// </summary>
    public class eAdminExtensionAccounting : eAdminExtension
    {
        ...
        [JsonConstructor]
        public eAdminExtensionAccounting(eAdminExtensionInfo infos) : base()
        {
            this.Infos = infos;
        }
        ...
        public eAdminExtensionAccounting(ePref pref, eUserOptionsModules.USROPT_MODULE module) : base(pref, module)
        {
