...
namespace Com.Eudonet.Xrm.eda
{
    ...
    /// Extension LinkedIn
    /// </summary>
    public class eAdminExtensionLinkedin: eAdminExtension
    {
        ...
        [JsonConstructor]
        public eAdminExtensionLinkedin(eAdminExtensionInfo infos) : base()
        {
            this.Infos = infos;
        }
        ...
        public eAdminExtensionLinkedin(ePref pref) : base(pref, eUserOptionsModules.USROPT_MODULE.ADMIN_EXTENSIONS_LINKEDIN)
        {
            string strError = "";
