...
{
    /// <summary>
    /// classe permettant de crypter les informations de connection
    /// </summary>
    public static class eMD5
    {
        ...
        private static string WordToHex(long lValue)
        {
            ...
            for (lCount = 0; lCount <= 3; lCount++)
            {
                ...
                string _tmpHex=string.Empty;
                if (lByte == 0)
                    _tmpHex = "000";
                else

                    _tmpHex = "0" + ToHex(lByte);

                WordToHex = WordToHex + (_tmpHex.Substring(_tmpHex.Length - 2));
            }
            return WordToHex;
        }
        ...
        /// <summary>
        /// Cryptage du message en MD5
        /// </summary>
        /// <param name="sMessage">message à crypter</param>
        /// <returns>message crypté</returns>
        public static string EncryptMd5(string sMessage)
        {
            string MD5 = "";
            if ((sMessage==null))
                return string.Empty;
